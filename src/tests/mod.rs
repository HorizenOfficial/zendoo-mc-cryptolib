...
fn verify_zkproof_test() {
    ...
    let constant_bytes: [u8; 96] = [
        186, 127, 207, 223, 64, 119, 142, 103, 3, 50, 129, 21, 163, 117, 112, 32, 220, 101, 83, 234,
        47, 9, 43, 145, 54, 190, 134, 235, 38, 70, 77, 22, 101, 181, 78, 112, 67, 114, 250, 99, 231,
        60, 22, 124, 137, 107, 62, 210, 152, 102, 57, 150, 16, 172, 67, 202, 23, 104, 45, 33, 222,
        108, 136, 246, 240, 149, 24, 185, 71, 15, 160, 38, 41, 90, 188, 95, 132, 174, 15, 9, 18,
        155, 97, 88, 215, 221, 121, 151, 13, 164, 209, 180, 183, 28, 1, 0
    ];
